  ...
  <div>
    <div class="row">
      <div class="col-12 col-md-12 order-3 order-md-2">
        <div class="row">
          <div class="col-sm-12 col-md-6 col-lg-3 mb-4" @click="redirect('/wallet/funding-history')">
            <div class="card">
              <div class="card-body">
          ...
          <div class="col-sm-12 col-md-6 col-lg-3 mb-4" @click="redirect('/data')">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
          ...
          <div class="col-sm-12 col-md-6 col-lg-3 mb-4" @click="redirect('/merchant/resellers')">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
          ...
          <div class="card-body">
            ...
            <ul class="p-0 m-0">
              <li
                ...
                @click="redirect(`/merchant/network-providers/${summary['network_provider_id']}`)"
              >
      ...
      <div class="col-md-6 col-lg-4 order-2 mb-4">
        <div class="card h-100">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="card-title m-0 me-2">Top Transactions</h5>
            <div class="dropdown">
              <button
                class="btn p-0"
                type="button"
          ...
          <div class="card-body">
            <ul class="p-0 m-0">
              <li
                ...
                @click="redirect(`/merchant/network-providers/${transaction['network_provider_id']}`)"
              >
                <div class="avatar flex-shrink-0 me-3">
...
export default {
  ...
  mounted() {
    ...
    this.xhrGet(apiMerchantUrl('dashboard'))
      .then(resp => {
        ...
        metrics.total_data_transactions = formatKobo(total_transactions)
