  ...
  <div>
    <div class="row">
      <div class="col-12 col-md-12 order-3 order-md-2">
        <div class="row">
          <div class="col-sm-12 col-md-6 col-lg-3 mb-4" @click="redirect('/merchant/payments')">
            <div class="card">
              <div class="card-body">
          ...
          <div class="col-sm-12 col-md-6 col-lg-3 mb-4" @click="redirect('/merchant/data/transactions')">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
