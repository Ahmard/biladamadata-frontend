      ...
      <div class="nav-container">
        ...
        <ul class="nav-links desktop-nav">
          ...
          <li>
            ...
            <NuxtLink v-else to="/login"><button class="btn-primary">Login</button></NuxtLink>
          </li>
        </ul>
            ...
            <ul class="mobile-nav-links">
              ...
              <li>
                <NuxtLink v-if="isAuthenticated" to="/dashboard">
                  <button class="btn-primary btn-block">Dashboard</button>
                </NuxtLink>
                <NuxtLink v-else to="/login">
                  <button class="btn-primary btn-block">Login</button>
                </NuxtLink>
              </li>
            </ul>
          </div>
